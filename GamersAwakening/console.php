...
<main>
    <center>
    <form class="form" method="POST" action="./control_Reviews.php">
        <h3>Nueva Reseña</h3>
        <hr>
        ...
        <label for="week">Juego de la semana:</label>
        <input type="radio" name="week" id="nweek" value=0 checked>No</input>
        <input type="radio" name="week" id="sweek" value=1>Si</input><br>
